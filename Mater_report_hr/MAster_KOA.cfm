...
<!--- <cfscript>
	...
	d_t_net_with=d_t_net_with + numberFormat( ISSIZLIK_ISVEREN_HISSESI_7103,'_,9.99');;
	d_t_diff=d_t_diff + numberFormat(((((ISSIZLIK_ISCI_HISSESI + ISSIZLIK_ISVEREN_HISSESI)* DAMGA_VERGISI_INDIRIMI_7103)- ((ISSIZLIK_ISCI_HISSESI + ISSIZLIK_ISVEREN_HISSESI)* GELIR_VERGISI_INDIRIMI_7103)) / DAMGA_VERGISI_INDIRIMI_7103 ),'_,9.99');
	d_t_adv=d_t_adv + (NET_UCRET - (((ISSIZLIK_ISCI_HISSESI + ISSIZLIK_ISVEREN_HISSESI) * DAMGA_VERGISI_INDIRIMI_7103)- ((ISSIZLIK_ISCI_HISSESI + ISSIZLIK_ISVEREN_HISSESI) * GELIR_VERGISI_INDIRIMI_7103)) / DAMGA_VERGISI_INDIRIMI_7103  );
